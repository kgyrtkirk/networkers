...
Adott egy sík, melyen elõre nem ismert helyeken olyan egységek vannak (klienspontok), melyek nem tudnak kommunikálni egymással.
...
A klienspontok idõvel akár meg is szûnhetnek, ezért az algoritmusnak meg kell tudni birkóznia a változó világgal, melyben ezen pontok megszünhetnek vagy meghibásodhatnak.
...
Az \ref{start} ábrán látható egy elképzelt kezdeti állapot. A networkerek semmilyen információval nem rendelkeznek a klienspontokról, de a céljuk, hogy valamilyen hálózatot építsenek ki azok közé (\ref{start2}).
